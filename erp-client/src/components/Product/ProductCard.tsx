...
function ProductCard({ product }: any) {
  ...
  const id = product?.node?.handle || "1"
    ...
    >
      <div className="relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg">
        ...
        <div className="mt-4 px-5 pb-5">
          <a href="#">
            <h5 className="text-xl tracking-tight text-gray-900">Nike Air MX Super 2500 - Red</h5>
          </a>
          <div className="mt-2 mb-5 flex items-center justify-between">
            <p>
              <span className="text-3xl font-bold text-gray-900">$449</span>
              <span className="text-sm text-gray-900 line-through">$699</span>
            </p>
