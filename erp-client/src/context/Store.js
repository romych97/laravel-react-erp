...
const CartContext = createContext({defaultValue:null})
const AddToCartContext = createContext({defaultValue:null})
const UpdateCartQuantityContext = createContext({defaultValue:null})
